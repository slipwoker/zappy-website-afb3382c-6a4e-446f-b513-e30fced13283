    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '25497d0b-eff2-4c16-a278-5f87fa10d285',
                    name: data.name || '',
                    email: data.email || '',
...
(function () {
  ...
  const items = document.querySelectorAll('.lectures-faq-item');

  items.forEach(function (item) {
    const btn = item.querySelector('.lectures-faq-question');
    if (!btn) return;
    ...
    btn.addEventListener('click', function () {
      ...
      items.forEach(function (other) {
        if (other !== item) {
          ...
          const otherBtn = other.querySelector('.lectures-faq-question');
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'afb3382c-6a4e-446f-b513-e30fced13283';
